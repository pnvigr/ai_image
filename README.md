...
- [ ] **Фаза 2** — аутентификация (JWT)
- [ ] **Фаза 3** — история анализов + ручная отметка «зашёл / результат / payout»
- [ ] **Фаза 4** — токены + платная модель + админка
- [ ] **Фаза 5** — аналитика сделок и рекомендации инструментов
